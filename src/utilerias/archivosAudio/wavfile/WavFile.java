...
// Version 1.0
package utilerias.archivosAudio.wavfile;
...
public class WavFile
{
	...
	private FileOutputStream oStream;	// Output stream used for writting data (Escritura de datos)
	private FileInputStream iStream;		// Input stream used for reading data (Lectura de datos)
